...
export class DatabaseUserRepository implements UserRepository {
    ...
    async findByUsername(username: string): Promise<UserM> {
        return await this.userEntityRepository.findOne({ where: { username: username } });
    }
    ...
    private toUserEntity(user: UserM): User {
        ...
        userEntity.last_login = new Date();
