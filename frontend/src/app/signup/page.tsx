...
export default function Home() {
    ...
    const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
        ...
        try {
            await fetchData('user/user', undefined, 'POST', { username, password })
                    ...
                    <div className="flex flex-col items-center justify-center p-6 bg-cadet-gray rounded-lg shadow-lg">
                        ...
                        <form className="w-full max-w-sm" onSubmit={handleSubmit}>
                            ...
                            <div className="text-center">
                                <ButtonPersona img1="./fonts/cadastro.png" img2="./fonts/cadastro2.png" />
                            </div>
                        </form>
                        <p className="mt-4 ">
                            <a href="/" className=" hover:underline"><i className="fa-solid fa-user-ninja" /> Já tem cadastro? Login </a>
                        </p>
                    </div>
                </div>
            </main>
